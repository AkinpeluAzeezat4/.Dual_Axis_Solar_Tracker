...
This project is a modular Predictive Maintenance System for Industrial Motor Monitoring built around the ESP32-S3 WROOM-1U using a structured PlatformIO architecture.
...
The relay disconnects the motor automatically when:
...
- Use proper isolation when working with industrial motors
