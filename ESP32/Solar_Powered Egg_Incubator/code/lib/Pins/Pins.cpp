...
void begin(){
pinMode(BATTERY_LEVEL,INPUT); pinMode(SOLAR_LEVEL,INPUT);
...
pinMode(BUZZER,OUTPUT); pinMode(HEATER_RELAY,OUTPUT); pinMode(SPINNER_RELAY,OUTPUT); pinMode(HUMIDIFIER_RELAY,OUTPUT);
digitalWrite(ULTRASONIC_TRIG,LOW); digitalWrite(BUZZER,LOW);
digitalWrite(HEATER_RELAY,HIGH); digitalWrite(SPINNER_RELAY,HIGH); digitalWrite(HUMIDIFIER_RELAY,HIGH);
}
