...
namespace local_server
{
  ...
  const char *apSsid = "Smart_Hybrid_IOT_energy_management_System";
...
<head>
  ...
  <title>Smart Hybrid IOT Energy Management System</title>
  <style>
    :root{
      --bg:#edf4ff;
      --bgGlow1:#dbeafe;
    ...
    <div class="wrap">
      <div class="topbar">
        <div class="titleBlock">
          <h1>Smart Hybrid IOT Energy Management System</h1>
